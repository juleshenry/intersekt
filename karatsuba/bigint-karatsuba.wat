(module
  ...
  ;; Karatsuba multiplication for bigints
  (func $bigint_karatsuba (param $x i32) (param $y i32) (result i32)
    ...
    ;; Increased threshold to reduce recursion overhead
    (if (i32.or (i32.le_u (local.get $len_x) (i32.const 8)) (i32.le_u (local.get $len_y) (i32.const 8)))
      (then
        (return (call $bigint_mul_simple (local.get $x) (local.get $y)))
      )
    )
